...
object Paragraph {
    def authenticated[T: Writes](fn: (UserId, Long, JsValue) => Query.Exec[T])(implicit global: api.Global) =
    ...
    def public[T: Writes](fn: (Long, JsValue) => Query.Exec[T])(implicit global: api.Global) =
