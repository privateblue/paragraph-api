...
case class Sessions(config: Config)(implicit system: ActorSystem) {
    ...
    def get(token: String)(implicit ec: ExecutionContext): Future[Throwable \/ UserId] =
    ...
    def create(userId: UserId, expire: Long = 0)(implicit ec: ExecutionContext): Future[Throwable \/ String] = {
